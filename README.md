...
| Node | Role |
|------|------|
| machine01 | NameNode, ResourceManager, DataNode, NodeManager |
| machine02 | SecondaryNameNode, DataNode, NodeManager |
| machine03 | DataNode, NodeManager |
| machine04 | DataNode, NodeManager |
| machine05 | DataNode, NodeManager |
...
| File | Purpose |
|------|---------|
| `core-site.xml` | Defines default HDFS filesystem and NameNode host |
| `hdfs-site.xml` | Replication factor, WebHDFS, NameNode/DataNode storage directories |
| `mapred-site.xml` | Sets MapReduce framework to YARN |
| `yarn-site.xml` | ResourceManager host, shuffle services, NodeManager ports |
| `workers` | Lists all 5 nodes for daemon startup |
